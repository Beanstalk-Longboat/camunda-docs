...
- The [Zeebe gRPC API](/apis-tools/zeebe-api/grpc.md), which provides low-level gRPC access to the workflow engine.
- The [Node.js SDK](/apis-tools/node-js-sdk.md), which provides Node.js libraries for interacting with Camunda 8.
